...
<div class="container">
    ...
    <div class="form-group ">
        ...
        <label class="custom-label"><h1>Change biography</h1></label>
        </div>
        <input type="text" maxlength="255" name="about" class="form-control card" placeholder="I am...">
    
    </div>
    <div class="container" style="align-items: center; width:40%">
    <label class="custom-label"><h1>Change your profile photo</h1></label>
    <div class="card">
